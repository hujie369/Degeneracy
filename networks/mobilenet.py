"""
This file is used to define the MobileNet network, based on pytorch's file
...
class MobileNetV2(nn.Module):
    ...
    def fuse_model(self, is_qat=False):
        fuse_modules = quantization.fuse_modules_qat if is_qat else quantization.fuse_modules
        for m in self.modules():
...
def load_mobilenet(model_file='pretrained_models/mobilenet_pretrained_float.pth'):
    model = MobileNetV2()
